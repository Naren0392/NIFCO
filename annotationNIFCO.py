...
# Input image folder
img_dir = r"D:\downloads_archieve_14_07_2025\PartImages (1) - Copy\2_27734&35\New folder"
...
for img_file in os.listdir(img_dir):
    ...
    mask = gray < 150  # threshold: tweak if needed
    ...
    cv2.putText(annotated_img, "New_Part", (x, y - 10),
